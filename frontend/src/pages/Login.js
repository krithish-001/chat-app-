  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 dark:from-dark-900 dark:via-dark-800 dark:to-dark-900 p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-indigo-300 dark:bg-indigo-900 rounded-full mix-blend-multiply dark:mix-blend-soft-light filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-500 mt-6">
          © 2024 ChatApp. Secure & Private Messaging
        </p>
      </div>
    </div>
  );
